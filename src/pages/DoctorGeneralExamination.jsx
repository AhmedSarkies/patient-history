...
import { addGeneralExaminationData } from "../store/slices/generalExaminationSlice";
...
const DoctorGeneralExamination = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      try {
        dispatch(addGeneralExaminationData(values));
...
export default DoctorGeneralExamination;
