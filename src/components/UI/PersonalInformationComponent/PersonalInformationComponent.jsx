...
const PersonalInformationComponent = ({ logout }) => {
  return (
    <div className="d-flex flex-xl-row flex-column-reverse d-block justify-content-center align-items-center">
      ...
      <div className="col-xl-6 col-12 personal__information-info d-flex justify-content-end align-items-center gap-2 gap-sm-3 pe-md-3 pe-3 pt-4">
